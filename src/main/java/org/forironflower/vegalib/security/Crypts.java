...
public final class Crypts {
    ...
    public static String uuid() {
        return Objects.atos(UUID.randomUUID())
                .replace("-", "");
    }
    ...
    public static String uuid(int n) {
        String uuid = uuid();
        return Objects.strcut(uuid, 0, n);
    }
    ...
    public static String toByteHex(byte[] bytes) {
        ...
        for (byte b : bytes) {
            ...
            if (Objects.strlen(tmp) == 1)
                builder.append("0");
            builder.append(tmp);
        }
        return Objects.atos(builder);
    }
    ...
    public static final CryptEncoder Encoder = new CryptEncoder() {
        ...
        private String md5(byte[] b, int n) {
            try {
                ...
                int flag = n > 16 ? 0 : 8;
                return Objects.strcut(chars, flag, (n + flag));
        ...
        public String url(String source, String enc) {
            try {
                ...
                if (source.startsWith(CRYPT_PREFIX_HTTPS)) {
                    source = Objects.strcut(source, Objects.strlen(CRYPT_PREFIX_HTTPS), 0);
    ...
    public static final CryptDecoder Decoder = new CryptDecoder() {
        ...
        public String base64(String src) {
            return Objects.atos(Base64.getDecoder().decode(src));
        }
