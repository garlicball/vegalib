...
import org.forironflower.vegalib.Assert;
import org.forironflower.vegalib.annotations.Favorite;
import org.forironflower.vegalib.exception.ValidationException;
...
import static org.forironflower.vegalib.collection.Collections.listMap;
...
public class VegaDirectory implements Iterable<VegaFile> {
    ...
    public List<VegaFile> match(String regexp) {
        List<VegaFile> retval = org.forironflower.vegalib.collection.Collections.listOf();
    ...
    private List<VegaFile> openDirectory() {
        ...
        return org.forironflower.vegalib.collection.Collections.listMap(lf, VegaFile::new);
    }
