...
import org.forironflower.vegalib.exception.OpenException;
...
public class VegaFile extends File {
    ...
    static String _placeholder(String pathname) {
        if (org.forironflower.vegalib.Objects.strhas(pathname, PLACEHOLDER_USER_DIR_VALUE))
            pathname = pathname.replace(PLACEHOLDER_USER_DIR_VALUE, System.getProperty("user.dir"));

        if (org.forironflower.vegalib.Objects.strhas(pathname, PLACEHOLDER_USER_HOME_VALUE))
    ...
    public VegaFile(String pathname, Object... args) {
        this(org.forironflower.vegalib.Objects.strfmt(_placeholder(pathname), args));
    }
