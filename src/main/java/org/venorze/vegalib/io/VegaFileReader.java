 ...
 * @author venorze
 */
public class VegaFileReader extends FileInputStream {

    public VegaFileReader(@NotNull String name) throws FileNotFoundException {
        super(name);
    }

    public VegaFileReader(@NotNull File file) throws FileNotFoundException {
        super(file);
    }

    public VegaFileReader(@NotNull FileDescriptor fdObj) {
        super(fdObj);
    }
