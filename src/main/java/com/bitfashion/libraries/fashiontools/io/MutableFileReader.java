 ...
 */
public class MutableFileReader extends FileInputStream {

    public MutableFileReader(@NotNull String name) throws FileNotFoundException {
        super(name);
    }

    public MutableFileReader(@NotNull File file) throws FileNotFoundException {
        super(file);
    }

    public MutableFileReader(@NotNull FileDescriptor fdObj) {
        super(fdObj);
    }
