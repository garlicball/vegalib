 ...
 * 如果需要写入，您是否在找：
 * <pre>
 *     - {@link IOUtils#write(byte[], VagaFile)}
 *     - {@link IOUtils#write(String, VagaFile)}
 *     - {@link IOUtils#write(InputStream, VagaFile)}
 ...
 * @author thesmartkbd
 */
public class VagaFileWriter extends FileOutputStream {

    public VagaFileWriter(@NotNull String name) throws FileNotFoundException {
        super(name);
    }

    public VagaFileWriter(@NotNull String name, boolean append) throws FileNotFoundException {
        super(name, append);
    }

    public VagaFileWriter(@NotNull File file) throws FileNotFoundException {
        super(file);
    }

    public VagaFileWriter(@NotNull File file, boolean append) throws FileNotFoundException {
        super(file, append);
    }

    public VagaFileWriter(@NotNull FileDescriptor fdObj) {
        super(fdObj);
    }
