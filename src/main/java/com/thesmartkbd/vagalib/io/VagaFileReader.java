 ...
 * @author thesmartkbd
 */
public class VagaFileReader extends FileInputStream {

    public VagaFileReader(@NotNull String name) throws FileNotFoundException {
        super(name);
    }

    public VagaFileReader(@NotNull File file) throws FileNotFoundException {
        super(file);
    }

    public VagaFileReader(@NotNull FileDescriptor fdObj) {
        super(fdObj);
    }
